...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-02-2020 a las 02:27:21
...
ALTER TABLE `resultado_candidato`
  ...
  ADD KEY `fk_Resultado_Candidato_Solicitud_Candidato1` (`idSolicitud_Candidato`);
...
ALTER TABLE `solicitud_candidato_has_puesto`
  ADD KEY `fk_Solicitud_Candidato_has_Puesto_Solicitud_Candidato1` (`idSolicitud_Candidato`),
...
ALTER TABLE `resultado_candidato`
  ...
  ADD CONSTRAINT `fk_Resultado_Candidato_Solicitud_Candidato1` FOREIGN KEY (`idSolicitud_Candidato`) REFERENCES `solicitud_candidato` (`idSolicitud_Candidato`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `solicitud_candidato_has_puesto`
  ...
  ADD CONSTRAINT `fk_Solicitud_Candidato_has_Puesto_Solicitud_Candidato1` FOREIGN KEY (`idSolicitud_Candidato`) REFERENCES `solicitud_candidato` (`idSolicitud_Candidato`) ON DELETE NO ACTION ON UPDATE NO ACTION;
